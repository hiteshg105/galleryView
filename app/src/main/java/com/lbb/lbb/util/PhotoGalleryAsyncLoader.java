...
public class PhotoGalleryAsyncLoader extends AsyncTaskLoader<List<PhotoItem>> {
    ...
    /**
     * Load photo album image items in the background This is where the bulk of our work is done. This function is
     * called in a background thread and should generate a new set of data to be published by the loader.
     */
    @Override
